...
2. Every event has a randomly distributed length following a lognormal distribution with varying mean values and std
...
mean_list = np.linspace(start_test_values, end_test_values, n_test_values)
std_list = np.linspace(start_test_values, end_test_values, n_test_values)
n_lines = 500
...
for std in std_list:
    for mean in mean_list:
        ...
        ax.set_ylim([-(mean+std/4), mean+std/4])
