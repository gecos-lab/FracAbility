...
data = pd.read_csv('Salza/Spacing_Salza_S1_out/output/csv/Fractures_1.csv', index_col=0, sep=';')  # Read the data
# data = pd.read_csv('../Spacing_Salza_S2/output/csv/Fractures_1.csv', index_col=0, sep=';')  # Read the data
